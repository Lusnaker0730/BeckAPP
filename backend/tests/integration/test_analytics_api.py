...
class TestAnalyticsEndpoints:
    ...
    def test_get_diagnosis_analysis(self, authenticated_client):
        ...
        response = client.get(
            "/api/analytics/diagnosis", params={"diagnosis": "influenza", "timeRange": "yearly"}
        )
        assert response.status_code == 200
    ...
    def test_get_diagnosis_by_code(self, authenticated_client):
        ...
        response = client.get(
            "/api/analytics/diagnosis-by-code", params={"code": "38341003"}  # Hypertension
        )
        assert response.status_code == 200
...
class TestAnalyticsAuthorization:
    ...
    def test_diagnosis_analysis_requires_authentication(self, client: TestClient):
        ...
        response = client.get("/api/analytics/diagnosis", params={"diagnosis": "influenza"})
